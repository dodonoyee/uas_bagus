        ...
        <div id="top-header">
            <div class="container">
                <ul class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> +62 878 5175 5215</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i> orion@mrkt.com</a></li>
                </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="header-logo">
                            <a href="#" class="logo">
                                <img style="margin-top: 10px;" src="<?= base_url() ?>/assets/img/logos.png" alt="">
                            </a>
                        </div>
                    </div>
                    <!-- /LOGO -->
